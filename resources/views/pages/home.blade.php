...
@section('content')
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="img/hero/heroo-0.png">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6>Clothing Collection</h6>
                                <h2>Batik - Exclusive Collections </h2>
                                <p>Indonesian archipelago exclusive batik fashion</p>
            ...
            <div class="hero__items set-bg" data-setbg="img/hero/hero-11.png">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6>Make Up Collection</h6>
    ...
    <section class="banner spad" style="margin-top: -4rem;">
        <div class="container">
            <div class="mb-2">
                <h3>Categories</h3>
            </div>
            <div class="row">
                ...
                <div class="col-3">
                    <div class="banner__item__pic">
                        <img src="img/banner/banner-10.png" alt="">
                    </div>
                    <div class="text-center mt-1">
                        Womens
                    </div>
                ...
                <div class="col-3">
                    <div class="banner__item__pic">
                        <img src="img/banner/banner-21.png" alt="">
                    </div>
                    <div class="text-center mt-1">
                        Bags
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        ...
                        <div class="instagram__pic__item set-bg" data-setbg="img/instagram/ig-1.jpg"></div>
